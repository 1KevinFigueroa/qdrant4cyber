...
- Python packages:
  ...
  - `pinecone`
- Local Pinecone index running and populated with Nuclei vectors (for example via `nuclei_to_pinecone-MiniLM-L6.py`)
...
Run commands from the same directory as `query_nuclei-pinecone-MiniLM-L6.py`.
