<table align="center">
  ...
  <tr>
    <td align="center" width="50%">
      <a href="">
        <img src="https://github.com/1KevinFigueroa/vector4cyber/blob/main/ContextCluesKit/RTFM-Knowledge/img/appLogos/sslscan.png" width="300" alt="Amass Logo">
      </a>
    </td>
    <td align="center" width="50%">
...
The problem with sslscan's output to a text file will be structured subdomains in a list. When the output in a JSON file 
...
- Joining WHOIS, DNS, HTTP fingerprinting, or vulnerability scan data