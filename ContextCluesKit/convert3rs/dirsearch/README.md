<table align="center">
  ...
  <tr>
    <td align="center" width="50%">
      <a href="">
        <img src="https://github.com/1KevinFigueroa/vector4cyber/blob/main/ContextCluesKit/RTFM-Knowledge/img/appLogos/dirsearch.svg" width="150" alt="dirsearch Logo">
      </a>
    </td>
    <td align="center" width="50%">
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repo-blue?logo=github)](https://github.com/1KevinFigueroa/vector4cyber/tree/main/CyberToolConverterKit/dirsearch)
...
**Raw dirsearch text output** → **Structured JSON** → **Vectorized Intelligence**
...
|--------------|---------------|------------|
| ✅ **Qdrant** |  ✅ | <a href="https://github.com/1KevinFigueroa/vector4cyber/tree/main/ingest3rs/Qdrant/dirsearch" target="_blank" rel="noopener noreferrer">✅ Completed</a> |
...
## 💡 The Solution
> **Usage: usage: convert_dirsearch.py [-h] input_file output_file**

```bash
convert_dirsearch.py input_file.txt output_file.json
