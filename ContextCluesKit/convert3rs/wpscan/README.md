<table align="center">
  ...
  <tr>
    <td align="center" width="50%">
      <a href="">
        <img src="https://github.com/1KevinFigueroa/vector4cyber/blob/main/ContextCluesKit/RTFM-Knowledge/img/appLogos/wpscan.png" width="150" alt="Python WHOIS ">
      </a>
    </td>
    <td align="center" width="50%">
...
### Python WHOSIS JSON file structure output example ❌
