<table align="center">
  ...
  <tr>
    <td align="center" width="50%">
      <a href="">
        <img src="https://github.com/1KevinFigueroa/vector4cyber/blob/main/ContextCluesKit/RTFM-Knowledge/img/appLogos/subfinder.png" width="300" alt="Amass Logo">
      </a>
    </td>
    <td align="center" width="50%">
...
- Reads a text file containing subfinder information
...
- Joining subdomains with scan data