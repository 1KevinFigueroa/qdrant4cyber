<table align="center">
  ...
  <tr>
    <td align="center" width="50%">
      <a href="">
        <img src="https://github.com/1KevinFigueroa/vector4cyber/blob/main/ContextCluesKit/RTFM-Knowledge/img/appLogos/assetfinder.png" width="300" alt="Assetfinder Logo">
      </a>
    </td>
    <td align="center" width="50%">
...
## 💡 The Solution
> **Usage: convert_assetfinder.py [-h] [-o output_file] [input_file]**
