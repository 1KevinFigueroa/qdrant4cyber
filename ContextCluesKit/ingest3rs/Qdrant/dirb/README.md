<table align="center">
  ...
  <tr>
    <td align="center" width="50%">
      <a href="">
        <img src="https://github.com/1KevinFigueroa/vector4cyber/blob/main/ContextCluesKit/RTFM-Knowledge/img/appLogos/dirb.png" width="150" alt="Amass Logo">
      </a>
    </td>
    <td align="center" width="50%">
...
# Ingest3r → DIRB results  → JSON Converter vectorized → Qdrant
