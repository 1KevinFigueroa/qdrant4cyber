...
It is designed to be used after converting raw Nuclei CLI output into structured JSON (for example, with `nuclei_to_json.py`).
...
Run from the same directory as `nuclei_to_chromadb-MiniLM-L6.py`.
