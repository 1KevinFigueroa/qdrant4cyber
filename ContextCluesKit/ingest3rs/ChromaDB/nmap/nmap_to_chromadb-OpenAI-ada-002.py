...
def import_to_chromadb(data):
    """Import nmap data into ChromaDB collection with openAI Embedding."""
    try:
        ...
        # Create or get collection and using the openAI embedding function
        ...
        try:
            ...
            print(f"✓ Created new collection '{collection_name}' using openAI embedding")
