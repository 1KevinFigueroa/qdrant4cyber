...
It is intended to run after the Nuclei conversion step (for example, `convert_nuclei_json-pinecone.py`).
...
Run commands from the same directory as `nuclei_to_pinecone-MiniLM-L6.py`.
