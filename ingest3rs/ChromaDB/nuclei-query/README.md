...
This script queries Nuclei findings stored in a ChromaDB collection named `nuclei-import`.
...
- Existing collection: `nuclei-import`
  - Populate it first with `ingest3rs/ChromaDB/nuclei-import/nuclei_to_chromadb-MiniLM-L6.py`
